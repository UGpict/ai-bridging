...
{"status":"complete","tasks":[{"title":"タスク名","description":"詳細説明","requiredSkill":"documentation|communication|technical|ci_cd","deadline":"project"}]}

【requiredSkillの選び方】
- documentation: 資料作成・ドキュメント・報告書
- communication: 調整・連絡・折衝・会議
- technical: 技術作業・開発・設定・セットアップ
- ci_cd: CI/CD・デプロイ・GitHub Actions・パイプライン・インフラ`;
...
{"status":"questioning","message":"質問文"}
- タスク分解完了時は必ず以下のJSON形式で返す（マークダウン不要）:
{"status":"complete","tasks":[{"title":"タスク名","description":"詳細説明（今日中に完了すべき内容を明記）","requiredSkill":"documentation|communication|technical|ci_cd","deadline":"today"}]}
