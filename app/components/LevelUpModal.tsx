...
const STARS: { top: string; left: string; color: string; tx: string; ty: string }[] = [
  { top: "8%",  left: "12%", color: "#FFD700", tx: "-35px", ty: "-60px" },
  { top: "6%",  left: "48%", color: "#FF6B6B", tx: "0px",   ty: "-70px" },
  { top: "8%",  left: "84%", color: "#4ECDC4", tx: "35px",  ty: "-60px" },
  { top: "48%", left: "3%",  color: "#45B7D1", tx: "-65px", ty: "0px"   },
  { top: "48%", left: "94%", color: "#96CEB4", tx: "65px",  ty: "0px"   },
  { top: "88%", left: "12%", color: "#FFEAA7", tx: "-35px", ty: "60px"  },
  { top: "90%", left: "48%", color: "#DDA0DD", tx: "0px",   ty: "70px"  },
  { top: "88%", left: "84%", color: "#98FB98", tx: "35px",  ty: "60px"  },
];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      ...
      >
        {/* LEVEL UP! */}
        <p
          className={`text-4xl font-black tracking-widest bg-gradient-to-r ${toC.gradient} bg-clip-text text-transparent`}
        >
          LEVEL UP!
        </p>
        ...
        <button
          onClick={onClose}
          className={`w-full py-3 rounded-xl text-white font-bold text-base bg-gradient-to-r ${toC.gradient} hover:opacity-90 transition-opacity active:scale-95`}
        >
          やった！
        </button>
      </div>
